// /// Purchase History DetailsScreen
//
...
//   const PurchaseHistoryDetailsScreen({super.key});
//
//   @override
...
//   void initState() {
//     super.initState();
//     BlocProvider.of<PurchaseHistoryBloc>(context).add(GetPurchaseHistoryDetails(
//         purchaseHistoryDetailsRequest:
//         PurchaseHistoryDetailsRequest(purchaseId: '')));
//   }
//
//   @override
...
//     return WillPopScope(
//       onWillPop: () async {
//         BlocProvider.of<PurchaseHistoryBloc>(context).add(GetPurchaseHistory(
