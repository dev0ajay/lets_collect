...
PrivacyPoliciesResponse privcayPoliciesFromJson(String str) => PrivacyPoliciesResponse.fromJson(json.decode(str));

String privcayPoliciesToJson(PrivacyPoliciesResponse data) => json.encode(data.toJson());
...
class PrivacyPoliciesResponse {
  ...
  factory PrivacyPoliciesResponse.fromJson(Map<String, dynamic> json) => PrivacyPoliciesResponse(
